...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const zomatoHeading = document.createElement("h1");
  zomatoHeading.textContent = "zomato";
  zomatoHeading.className = "zomato-title"; // CSS class

  header.appendChild(zomatoHeading);
});
...
function createProductCard(product) {
     ...
     button.innerHTML = "<img src='icon-add-to-cart.svg' alt='cart icon'> Add to Cart";
